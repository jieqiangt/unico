...
CREATE TABLE IF NOT EXISTS ft_customer_group_price_check_flagged_orders (
    ...
    std_in_price NUMERIC(10, 2) NOT NULL,
    distinct_customers_count NUMERIC(10, 2) NOT NULL,

...
from utils.dataProcessing import process_current_inventory_report
import pandas as pd
import os
...
def export_current_inventory_report():
    ...
    cols_to_drop = ['avg_price','last_purchase_date','last_purchase_price','breakeven_price']
    ...
    process_current_inventory_report(inv_with_price, f"{file_name}_with_price")
    record_data_refresh_log(f'{file_name}_excel')
